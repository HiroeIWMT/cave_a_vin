...
public class TestRequetesPlusPoussees {
    ...
    private void jeuDeDonneesPaniersClients() {
        ...
        final LignePanier lp1 = LignePanier
                ...
                .bouteille(b2)
                .quantite(3)
              //  .prix(new BigDecimal(3 * b2.getPrix()))
                .prix(b2.getPrix().multiply(BigDecimal.valueOf(3)))
                .build();
        ...
        final LignePanier lp2 = LignePanier
                ...
                .quantite(10)
              // .prix(10 * b1.getPrix())
                .prix(b1.getPrix().multiply(BigDecimal.valueOf(10)))
                .build();
        ...
        final LignePanier lp3 = LignePanier
                ...
                .quantite(4)
               // .prix(3 * b3.getPrix())
                .prix(b3.getPrix().multiply(BigDecimal.valueOf(3)))
                .build();
    ...
    void test_utilisateurRepository_findCommandesWithSQL() {
        final List<Panier> commandes = panierRepository.findByCommandesWithSQL(tom.getPseudo());
        // Vérification
